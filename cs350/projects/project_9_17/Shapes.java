...
public class Shapes extends JPanel  //Shapes inherits from Jpanel
{
         ...
         switch ( choice )
         {
            case 1: // draw rectangles
               g.drawRect( 10 + i * 10, 10 + i * 10, 
                  50 + i * 10, 50 + i * 10 ); //drawRect(x,y,w,h)
               break;
            case 2: // draw ovals
//               g.drawOval( 10 + i * 10, 10 + i * 10, 
//                  50 + i * 10, 50 + i * 10 );
               g.drawArc( 10 + i * 10, 10 + i * 10, 
                       50 + i * 10, 50 + i * 10, 0, 360 ); //drawArc(x,y,w,h) /inscribes oval inside drawRect(x,y,w,h)
               break;
...
//                   50 + i * 10, 50 + i * 10 );
                g.fillArc( 10 + i * 10, 10 + i * 10, 
                        50 + i * 10, 50 + i * 10, 0, 360 ); //fillArc(x,y,w,h,fillStartDegree,fillEndDegree)
                break;
            default: // draw lines
      ...
      choice=(choice+1)%5; 	//event handling.  paintComponent is called on redraw.  Once paintComponent gets called, it adds 1 to choice, so that the next time it's called,
      						//it uses the new choice value.
      // end of addition
